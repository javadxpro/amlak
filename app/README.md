...
## نکات
- **تعداد ملک‌ها نامحدود است** — اپ و سایت هیچ محدودیت ۱۰تایی ندارند؛ با صفحه‌بندی ۱۲تایی و دکمه «نمایش بیشتر» می‌توانید ۵۰، ۲۰۰ یا ۱۰۰۰+ ملک داشته باشید بدون افت کارایی.
...
- نمونه فعلی شامل ۵۰ ملک برای تست نامحدود بودن است
